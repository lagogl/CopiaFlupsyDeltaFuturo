...
/**
 * In server/db-storage.ts, sostituire il metodo deleteFlupsy con la versione corretta:
 */
    ...
    try {
      ...
      await db.transaction(async (tx) => {
        ...
        if (basketIds.length > 0) {
          ...
          // FIX: Utilizziamo inList invece di sql template per la clausola IN
          ...
          try {
            ...
            // FIX: Utilizziamo or e inList invece di sql template per la clausola IN
            await tx
