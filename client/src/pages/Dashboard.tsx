...
import DraggableBasicFlupsyVisualizer from '@/components/dashboard/DraggableBasicFlupsyVisualizer';
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <div>
        ...
        {/* FLUPSY Visualizer */}
        <div className="mb-8">
          <DraggableBasicFlupsyVisualizer />
        </div>
