                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="space-y-1 bg-purple-50 dark:bg-purple-900/20 p-2 rounded-md">
                    ...
                    <Input
                      ...
                      className="h-9 bg-white dark:bg-slate-800 border-purple-200 dark:border-purple-800 font-mono text-base"
                    />
                  </div>
                  
                  <div className="space-y-1 bg-indigo-50 dark:bg-indigo-900/20 p-2 rounded-md">
                    <Label htmlFor="animalCount" className="text-indigo-700 dark:text-indigo-400 font-medium text-sm">
                      Numero Totale Animali
                    </Label>
                    <Input
                      id="animalCount"
                      ...
                      className="h-9 bg-white dark:bg-slate-800 border-indigo-200 dark:border-indigo-800 font-mono text-base"
                    />
                  </div>
                </div>
                
                {/* Mostra percentuale mortalità */}
                {destinationBasketData.sampleCount > 0 && destinationBasketData.deadCount > 0 && (
                  <div className="text-right mt-2">
                    <span className="text-sm px-3 py-1 rounded-full bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300">
                      Percentuale Mortalità: {((destinationBasketData.deadCount / destinationBasketData.sampleCount) * 100).toFixed(2)}%
                    </span>
                  </div>
                )}
              </div>
