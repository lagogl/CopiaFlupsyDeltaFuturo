  ...
  return (
    <Form {...form}>
      <form onSubmit={onSubmitForm} className="space-y-4">
        {/* Mostra un avviso se abbiamo una cesta attiva ma senza cicli */}
        {watchBasketId && isActiveBasketWithNoCycles && (
          <div className="text-sm text-amber-600 p-3 border border-amber-200 rounded-md bg-amber-50 mb-3">
            <div className="flex items-center mb-1">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1.5" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
              <strong>Attenzione: Cesta senza ciclo attivo</strong>
            </div>
            <div className="ml-7">
              La cesta #{selectedBasket?.physicalNumber} è attiva ma non ha un ciclo assegnato.
              Per registrare operazioni su questa cesta, è necessario prima creare un nuovo ciclo
              con l'operazione <strong>"Prima Attivazione"</strong>.
            </div>
          </div>
        )}
